  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Code Examples', href: '/tutorials' },
        { name: 'Tech Webinars', href: '/webinars' },
        { name: 'Implementation Stories', href: '/case-studies' },
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">+1 (800) TECH-NOW</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get technical insights and platform updates. Enterprise-focused content only.
              </p>
            </div>
          </div>
